...
public class CameraMovement : MonoBehaviour
{
    ...
    void LateUpdate()
    {
        ...
        float roty = Mathf.LerpAngle(transform.eulerAngles.y, player.transform.eulerAngles.y, 1f * Time.deltaTime);
        Quaternion rotation = Quaternion.Euler(new Vector3(0, roty, 0));
